...
class FranchiseEnquiryExport implements FromCollection, WithHeadings, WithMapping, WithEvents
{
    use Exportable;
    ...
    public function __construct()
    {
        ...
        $this->rowCount = FranchiseEnquiry::count() + 1; // Adding 1 for the header row
