...
$(document).on('click', '.addToCartBtn', function () {
    ...
    let isExist = cartItems.some(item => 
...
function displayCartItems() {
 ...
 $('.center-main').html(cartItems.length);
    ...
    if (cartItems.length == 0) {
        ...
        $('.offer-viewbag').hide();
        $('.offer-viewbag-total-cart').hide();
    } else {
        $(".add-cart-footer").show();
        $('.offer-viewbag').show();
        $('.offer-viewbag-total-cart').show();
    }
    ...
    cartItems.forEach(function (item, index) {
        ...
        // let product_selected_variant_sku = variants.colour.toLowerCase() + '_' + variants.size.toLowerCase();
        ...
        //         sku: product_selected_variant_sku,
        //      },
            ...
            <div class="add-cart-list" data-index="${index}">
                ...
                <div class="ac-r">
                    ...
                    <div class="input-increment">
                        <span class="input-number-decrement addToDecQtyBtn t1">–</span>
                        <input class="input-number quantityInputs" 
                            type="text" 
                            value="${item.quantity}" 
                            min="1" max="`+maxSellingQtyNew+`"
