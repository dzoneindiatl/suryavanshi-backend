...
function displayCartItems() {
    ...
    cartItems.forEach(function(item, index) {
        ...
        if (discountType === 'flat') {
            discountText = `${discountAmount} Rs Off`;
        ...
        let productHTML = `
            <div class="add-cart-list" data-index="${index}">
                ...
                <div class="ac-r">
                    <div class="price-tag"><span>₹${sellingPrice.toFixed(2)}</span></div>
                     ${discountHTML}
...
function priceCalculation(){
 ...
 console.log(subTotal);
    ...
    if (couponDiscount > 0) {
        ...
        $("#couponDiscount").html("0.00"); // Or use .text('') depending on your layout
    }
