...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td
            ...
            Thank you for shopping at Shoptjap
        </td>
    </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td
            ...
            We have received your order and will contact you when your parcel is shipped. Below is the purchase information.
        </td>
    </tr>
</table>
<!-- <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td style="text-align: center;">
            <a href="#"
                style="background-color:#171819; color:#ffffff; display:inline-block; font-size: 13px; font-weight:bold; line-height:36px; text-align:center; text-decoration:none; width:200px; margin-top: 35px;">
                Track My Order
            </a>
        </td>
    </tr>
                ...
                <tr>
                    <td style="padding: 20px 20px;">
                        ...
                        <table>
                            ...
                            <tr>
                                <td style=" padding-bottom: 30px; font-size: 14px;">2-7 Days </td>
                            </tr>
                            <tr>
