...
<body
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0"
        ...
        <tr>
         ...
         @if (!empty($ordertype) && $ordertype == 'order')
            <tr>
                <td colspan="2">
                    @php
                        $totalfinalamt = 0;
                        $totalfinalamt = $finaltotalamount + $order->shippingcharge;
                    @endphp
                    <table style="width:100%">
                        <tr>
                            <td align="left">
                                <b style="font-size: 14px;font-family: 'Nunito Sans', sans-serif;">Shipping Charge</b>
                                <span style="font-size: 14px;font-family: 'Nunito Sans', sans-serif;"> Rs.
                                    {{ $order->shippingcharge }}</span>
                            </td>
                            <td align="right">
                                <b style="font-size: 14px;font-family: 'Nunito Sans', sans-serif;">Final Total
                                    Amount</b>
                                <span style="font-size: 14px;font-family: 'Nunito Sans', sans-serif;"> Rs.
                                    {{ $totalfinalamt }}</span>
                            </td>
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="6">
                            ...
                            <div class="txt_sine" style="padding: 10px;">
                                <img height="70" width="70" src="<?php echo env('WEBSITE_URL'); ?>uploads/signatures/<?php echo $supplySetting->signature; ?>" />
                             </div>
    ...
    <table width="100%">
        ...
        <tr style="vertical-align: top;">
            <td>
                ...
                <p style="margin-bottom: 0;margin-top: 0;font-family: 'Nunito Sans', sans-serif;">
                    {{ $bAddress->billing_customer_name }}</p>
                <p style="margin-bottom: 0;margin-top: 0;font-size: 16px;font-family: 'Nunito Sans', sans-serif;">
                    {{ $bAddress->billing_address }},
                    {{ $bAddress->billing_city }},<br>
                    {{ $bAddress->billing_state }} - {{ $bAddress->billing_pincode }} ,
                    {{ $bAddress->billing_country }}</p>
                <p style="margin-bottom: 0;margin-top: 0;font-size: 16px;font-family: 'Nunito Sans', sans-serif;">
                    Phone No: {{ $bAddress->billing_phone }}</p>
            ...
            <td width="50%">
                ...
                <p style="margin-bottom: 0;margin-top: 0;font-size: 16px;font-family: 'Nunito Sans', sans-serif;">
                    Address: {{ $supplySetting->address }},
                    {{ $supplySetting->city->name }},<br>{{ $supplySetting->state->name }} -
                    {{ $supplySetting->pincode }} , {{ $supplySetting->country->name }}</p>
                <p style="margin-bottom: 0;margin-top: 0;font-size: 16px;font-family: 'Nunito Sans', sans-serif;">
                    Phone No: {{ $supplySetting->phone_number }}</p>
            </td>
