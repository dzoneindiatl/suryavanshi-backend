...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Size Charts</h1>
            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div class="prism-toggle">
                        ...
                        <a href="{{ route('admin-new-size-charts.create') }}" class="btn btn-primary">Add Size Chart</a>
                    </div>
                </div>
                ...
                <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                    ...
                    <thead>
                        <tr id="tableHeaders">
                            <th class="sortable" data-column="name">Category <i class="sort-icon ri-sort-asc"></i></th>
                            <th class="sortable" data-column="name">Size <i class="sort-icon ri-sort-asc"></i></th>
                            <th class="sortable" data-column="name">Chest <i class="sort-icon ri-sort-asc"></i></th>
                            <th class="sortable" data-column="name">Waist <i class="sort-icon ri-sort-asc"></i></th>
                            <th class="sortable" data-column="name">Hip <i class="sort-icon ri-sort-asc"></i></th>
                            <th class="sortable" data-column="name">Shoulder <i class="sort-icon ri-sort-asc"></i></th>
                            <th class="sortable" data-column="name">Armhole <i class="sort-icon ri-sort-asc"></i></th>
                            <th class="sortable" data-column="name">Sleeve Length <i class="sort-icon ri-sort-asc"></i>
                            </th>
                            <th class="sortable" data-column="name">Length <i class="sort-icon ri-sort-asc"></i></th>
                            <th class="sortable" data-column="created_at">Created At <i
                    ...
                    <tbody id="powerwidgets">
                        ...
                        @if ($results->isNotEmpty())
                            @include('admin.new-size-charts.load_more_data', ['results' => $results])
                        @else
                            <tr>
