...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Testimonials</h1>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="container mt-4">
                <button type="button" class="btn btn-outline-primary my-1 me-2" fdprocessedid="g9dg58f"> Total Testimonials:
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <thead>
                    <tr id="tableHeaders">
                        ...
                        <th class="sortable" data-column="rating">Rating <i class="sort-icon ri-sort-asc"></i></th>
                        <th>Action </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @include('admin.testimonials.load_more_data', ['results' => $results])
                    @else
                    <tr>
