        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="container mt-4">
                    <button type="button" class="btn btn-outline-primary my-1 me-2" fdprocessedid="g9dg58f"> Updated History Count:
                ...
                <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                    ...
                    <thead>
                        <tr id="tableHeaders">
                            ...
                            <th class="sortable" data-column="is_active">IP <i class="sort-icon ri-sort-asc"></i>
                            </th>
                    ...
                    <tbody>
                        ...
                        @if ($results->isNotEmpty())
                            @include('admin.coupons.load_more_data_logs', ['results' => $results])
                        @else
                            <tr>
