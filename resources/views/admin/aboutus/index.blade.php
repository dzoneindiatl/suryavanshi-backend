...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">About Us</h1>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="container mt-4">
                <button type="button" class="btn btn-outline-primary my-1 me-2" fdprocessedid="g9dg58f"> Total Sections:
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <tbody>
                    ...
                    @include('admin.aboutus.load_more_data', ['results' => $results])
                    @else
                    <tr>
