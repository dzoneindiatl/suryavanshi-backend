    ...
    <div class="ms-md-1 ms-0">
        <nav>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">New referral Setting</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="row">
    <div class="col-xl-12">
        <form action="{{ route('admin-referral_setting.save') }}" method="post" enctype="multipart/form-data" id="createCouponForm">
            @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="sender_amount" class="form-control form-control-solid form-control-lg @error('sender_amount') is-invalid @enderror" value="{{ old('sender_amount') }}" step="0.01">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="receiver_amount" class="form-control form-control-solid form-control-lg @error('receiver_amount') is-invalid @enderror" value="{{ old('receiver_amount') }}" step="0.01">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="start_date" class="form-control form-control-solid form-control-lg @error('start_date') is-invalid @enderror" value="{{ old('start_date') }}">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="end_date" class="form-control form-control-solid form-control-lg @error('end_date') is-invalid @enderror" value="{{ old('end_date') }}">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="validity" class="form-control form-control-solid form-control-lg @error('validity') is-invalid @enderror" value="{{ old('validity') }}" step="1">
