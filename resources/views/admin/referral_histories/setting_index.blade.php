...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Referral Settings</h1>
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    <!-- <button type="button" class="btn btn-primary mr-2" data-bs-toggle="modal" data-bs-target="#exampleModal">Add new setting</button> -->
                    <a href="{{ route('admin-referral_setting.create') }}" class="btn btn-primary"
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <tbody id="powerwidgets">
                    ...
                    @include('admin.referral_histories.setting_load_more_data', ['results' => $results])
                    @else
                    <tr>
...
<script>
    $('#search_user').on('keyup', function() {
        ...
        $('.userSpinner').show();
        $.ajax({
            url: '{{route("admin-referral_setting.userSearch")}}',
            type: 'POST',
            data: {
                'value': $value
    ...
    $(document).ready(function() {
        ...
        $('.toggle-status').on('click', function() {
            var id = $(this).data('id');
            $.ajax({
                url: '/referral-settings/' + id + '/toggle-status',
                type: 'PATCH',
