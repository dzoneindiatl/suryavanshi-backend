...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Cms Manager</h1>
    <div class="ms-md-1 ms-0">
        <nav>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('admin-dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Cms Manager</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    @can('create_cms')
                        <a href="{{ route('admin-cms-manager.create') }}" class="btn btn-primary"
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <thead>
                    <tr id="tableHeaders">
                        ...
                        <th class="sortable" data-column="title">Page Title <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="body">Description <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="gender">Created On <i class="sort-icon ri-sort-asc"></i></th>
                        <th>Action </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @include('admin.cms-manager.load_more_data', ['results' => $results])
                    @else
                    <tr>
