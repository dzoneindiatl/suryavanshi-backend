...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Specifications</h1>
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    <a href="{{ route('admin-specifications.add',base64_encode($record_id)) }}" class="btn btn-primary"
                    ...
                    <div>
                        ...
                        <div class="row mt-8">
                            <div class="col-lg-12">
                                ...
                                &nbsp;&nbsp;
                                <a href='{{ route("admin-"."$model.index",base64_encode($record_id))}}'
            ...
            <div class="container mt-4">
                <button type="button" class="btn btn-outline-primary my-1 me-2" fdprocessedid="g9dg58f"> Total Specifications:
                ...
                <table id="datatable-basic" class="table table-bordered text-nowrap" style="width:100%">
                    <thead>
                        <tr>
                            <th class="sortable" data-column="name" class="text-center">Name <i
                                    class="sort-icon ri-sort-asc"></i></th>
                            <th class="sortable" data-column="created_at" class="text-center">Added On <i
                                    class="sort-icon ri-sort-asc"></i></th>
                            <th class="sortable" data-column="is_active" class="text-center">Status <i
                                    class="sort-icon ri-sort-asc"></i></th>
                    ...
                    <tbody>
                        ...
                        @include('admin.specifications.load_more_data', ['results' => $results])
                        @else
                        <tr>
...
<script>
var routeName = '{{route($listRouteName,base64_encode($record_id))}}';
