...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Size Chart Detail</h1>
    <div class="ms-md-1 ms-0">
        <nav>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('admin-dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{  route('admin-size-charts.index')}}">Size Charts</a></li>
                <li class="breadcrumb-item active" aria-current="page">Size Chart Detail</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    <a href="{{ route('admin-size-chart-details.add',base64_encode($dep_id)) }}"
                    class="btn btn-primary">Add Size Chart Detail </a>
                </div>
            </div>
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <tbody id="powerwidgets">
                    ...
                    @include('admin.size-chart-details.load_more_data', ['results' => $results])
                    @else
                    <tr>
