        ...
        <div class="card custom-card">
            ...
            <div class="accordion accordion-solid accordion-toggle-plus" id="accordionExample6">
                <div id="collapseOne6" class="collapse m-3 {{ request('show')? 'show' : ''  }}" data-parent="#accordionExample6">
                    <div>
                        <form id="listSearchForm" class="row mb-6" method="GET" action="{{ route('admin-attributes.index') }}">
            ...
            <div class="container mt-4">
                <button type="button" class="btn btn-outline-primary my-1 me-2" fdprocessedid="g9dg58f"> Total Attributes:
                ...
                <table id="datatable-basic" class="table table-bordered text-nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        @include('admin.attributes.load_more_data', ['results' => $results])
                        @else
                        <tr>
