...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Brands</h1>
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <thead>
                    <tr id="tableHeaders">
                        ...
                        <th class="sortable" data-column="name">Primary Brand <i class="sort-icon ri-sort-asc"></i></th>
                ...
                <tbody>
                    ...
                    @include('admin.brand.load_more_data', ['results' => $results])
                    @else
                    <tr>
