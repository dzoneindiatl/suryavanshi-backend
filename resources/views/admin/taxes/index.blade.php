...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Taxes</h1>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
                    ...
                    <div>
                        <form id="listSearchForm" class="row mb-6">
                            ...
                            <div class="col-lg-3 mb-lg-5 mb-6">
                                ...
                                <input type="text" class="form-control" name="tax_type" placeholder="Tax Type"
                                    value="{{$searchVariable['tax_type'] ?? '' }}">
                            </div>
                            <div class="col-lg-3 mb-lg-5 mb-6">
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <thead>
                    <tr id="tableHeaders">
                        <th class="sortable" data-column="tax_option">Tax Option <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="tax_type">Tax Type <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="tax_from">Tax From <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="tax_to">Tax To <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="tax_rate">Tax Rate <i class="sort-icon ri-sort-asc"></i></th>
                ...
                <tbody id="powerwidgets">
                    ...
                    @include('admin.taxes.load_more_data', ['results' => $results])
                    @else
                    <tr>
