...
@include('admin.layout.response_message')
    ...
    <div class="row">
        <div class="col-xl-12">
            <form action="{{ route('admin-taxes.store') }}" method="post" id="taxForm" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input @error('tax_option') is-invalid @enderror"
                                                        ...
                                                        value="inclusive"
                                                        checked
                                                        {{ old('tax_option') === 'inclusive' ? 'checked' : '' }} required>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input @error('tax_option') is-invalid @enderror"
                                                        ...
                                                        id="excludeTax"
                                                        value="exclusive"
                                                        {{ old('tax_option') === 'exclusive' ? 'checked' : '' }} required>
                                            ...
                                            <div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input @error('tax_type') is-invalid @enderror"
                                                        ...
                                                        {{ old('tax_type') === 'flat' ? 'checked' : '' }} required>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input @error('tax_type') is-invalid @enderror"
                                                        ...
                                                        {{ old('tax_type') === 'floating' ? 'checked' : '' }} required>
                                        ...
                                        <div class="col-xl-10 mb-3 tax_floating_type_div" style="display:none">
                                            <div class="table-responsive">
                                                <table id="taxFloatingTable" class="table table-bordered">
                                                    ...
                                                    <tbody id="floatingTBody">
                                                        <tr>
                                                            <td>
                                                                <input type="number" name="tax_from[]" step="0.1" class="form-control">
                                                            </td>
                                                            <td>
                                                                <input type="number" name="tax_to[]" step="0.1" class="form-control">
                                                            </td>
                                                            <td>
                                                                <input type="text" name="tax_rate_floating[]" step="0.1" class="form-control">
                                                            </td>
                                                            <td>
                                        ...
                                        <div class="col-xl-10 mb-3 tax_flat_type_div">
                                            <div class="table-responsive">
