...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Fronted Manus</h1>
    <div class="ms-md-1 ms-0">
        <nav>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('admin-dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Fronted Manus</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    <a href="{{ route('admin-frontend-menus.create') }}" class="btn btn-primary"
                        style="margin-right: 10px;">
                        <!-- Adjust the margin-right as needed -->
                        Add New Fronted Manu
                    </a>
                </div>
            </div>
            ...
            <div class="container mt-4">
                <button type="button" class="btn btn-outline-primary my-1 me-2" fdprocessedid="g9dg58f"> Total Faqs:
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <thead>
                    <tr id="tableHeaders">
                        <th class="sortable" data-column="question">Title <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="answer">url <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="answer">Order <i class="sort-icon ri-sort-asc"></i></th>
                ...
                <tbody>
                    ...
                    @include('admin.menus.load_more_data', ['results' => $results])
                    @else
                    <tr>
