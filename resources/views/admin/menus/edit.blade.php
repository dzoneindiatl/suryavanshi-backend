...
<div class="row">
    <div class="col-xl-12">
        <form action="{{ route('admin-frontend-menus.update', base64_encode($menu->id)) }}" method="post" enctype="multipart/form-data"
            id="createUserForm">
            @csrf
            @method('PUT')
                                    ...
                                    <div class="card-body p-0">
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="menus[0][title]" required value="{{ old('title', $menu->title) }}" placeholder="Title">
                                                @if ($errors->has('title'))
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <input type="text" class="form-control @error('url') is-invalid @enderror" id="title" name="menus[0][url]" value="{{ old('url', $menu->url) }}" placeholder="Menu URL">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <input type="text" class="form-control @error('url') is-invalid @enderror" id="title" name="menus[0][order]" value="{{ old('order', $menu->order) }}" placeholder="Order">
                                                @if ($errors->has('url'))
                                                    <div class=" invalid-feedback">
                                                        {{ $errors->first('url') }}
                                                    </div>
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <select name="menus[0][is_active]" class="form-control">
