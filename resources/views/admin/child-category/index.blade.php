        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    @can('view_child_category')
                        <a href="{{ route('admin-child-category.add',base64_encode($dep_id)) }}" class="btn btn-primary">Add Child Category</a>
                    @endcan
                </div>
            </div>
            ...
            <div class="container mt-4">
                ...
                @can('edit_child_category')
                    <a href="{{ route('admin-category.priority.childmanage',base64_encode($dep_id)) }}" class="btn btn-secondary">
                        Manage Priority
                    </a>
                @endcan
            </div>
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <tbody id="powerwidgets">
                    ...
                    @include('admin.child-category.load_more_data', ['results' => $results])
                    @else
                    <tr>
