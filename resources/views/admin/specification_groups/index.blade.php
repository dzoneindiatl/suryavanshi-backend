...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Specification Groups</h1>
    <div class="ms-md-1 ms-0">
        <nav>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('admin-dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Specification Groups</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    <a href="{{ route('admin-specification-groups.create') }}" class="btn btn-primary"
            ...
            <div class="container mt-4">
                <button type="button" class="btn btn-outline-primary my-1 me-2" fdprocessedid="g9dg58f"> Total Specification Groups:
                ...
                <table id="datatable-basic" class="table table-bordered text-nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        @include('admin.specification_groups.load_more_data', ['results' => $results])
                        @else
                        <tr>
