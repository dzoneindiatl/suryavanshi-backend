...
<tr class="list-data-row" data-total-count="{{$totalResults}}">
    ...
    <td>
        <div class="hstack gap-2 flex-wrap">
            ...
            <a href="{{route('admin-specification-groups.edit',base64_encode($result->id))}}" class="btn btn-info"><i
            ...
            <div class="dropdown dropdown-inline">
                ...
                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                    <ul class="nav nav-hoverable flex-column">
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{route('admin-specifications.index',['endesid'=>base64_encode($result->id)])}}">
