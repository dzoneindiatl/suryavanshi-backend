    ...
    <div class="ms-md-1 ms-0">
        <nav>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Specification Group</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="row">
    <div class="col-xl-12">
        <form action="{{route('admin-specification-groups.update',base64_encode($recordDetails->id))}}" method="post"
            id="specificationGroupForm" autocomplete="off" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="specificationsRow card custom-card">
                                ...
                                <div data-repeater-item class="form-group row align-items-center mb-0">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <a href="javascript:;" data-repeater-create=""
                                            ...
                                            <i class="la la-plus"></i>Add More Specification Group
                                        </a>
                                        <a href="javascript:;" data-repeater-delete=""
                                            class="btn btn-sm font-weight-bolder btn btn-danger-light btn-border-down"
                                            style="display:none;">
                                            <i class="la la-trash-o"></i>Delete Specification Group
                                        </a>
                                        @else
                                        <a href="javascript:;" data-repeater-create=""
