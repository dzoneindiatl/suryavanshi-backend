...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Category Icons</h1>
    <div class="ms-md-1 ms-0">
        <nav>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('admin-dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Category Icons</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    @can('create_category_icon')
                        <a href="{{ route('admin-settings.category-icons.create') }}" class="btn btn-primary"
                    ...
                    <div>
                        ...
                        <div class="row mt-8">
                            <div class="col-lg-12">
                                ...
                                &nbsp;&nbsp;
                                <a href='{{ route("admin-settings.category-icons.index")}}'
            ...
            <div class="container mt-4">
                <button type="button" class="btn btn-outline-primary my-1 me-2" fdprocessedid="g9dg58f"> Total Icons:
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <thead>
                    <tr id="tableHeaders">
                        <th class="sortable" data-column="coupon_type">Icon <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="name">Title <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="name">Slug <i class="sort-icon ri-sort-asc"></i></th>
                ...
                <tbody>
                    ...
                    @include('admin.category-icons.load_more_data', ['results' => $results])
                    @else
                    <tr>
