			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<h5 class="text-dark font-weight-bold my-1 mr-5">
						Edit {{Config('constant.ACL.ACL_TITLE')}} </h5>
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
						<li class="breadcrumb-item">
							<a href="{{ route('admin-dashboard')}}" class="text-muted">Dashboard</a>
						</li>
						<li class="breadcrumb-item">
							<a href="{{ route('admin-'.$model.'.index')}}" class="text-muted">{{Config('constant.ACL.ACL_TITLE')}}</a>
						</li>
					</ul>
				</div>
			</div>
						...
						<div class="row">
							...
							<div class="col-xl-10">
								<h3 class="mb-10 font-weight-bold text-dark">
									{{Config('constant.ACL.ACL_TITLE')}} Information
								</h3>
								<div class="row">
									<div class="col-xl-6">
...
<script>
	...
	function acco_add_more_size() {
		...
		$.ajax({
			...
			url: '{{ route("admin-acl.addMoreRow") }}',
			'type': 'post',
			data: {
				'counter': counter
			},
