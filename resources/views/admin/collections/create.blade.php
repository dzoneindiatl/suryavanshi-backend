                                    ...
                                    <div class="card-body p-0">
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{isset($userDetails->name) ? $userDetails->name: old('title')}}" placeholder="Title">
                                                @if ($errors->has('title'))
                                             ...
                                             <div class="col-xl-6">
                                                <label for="title" class="form-label"><span class="text-danger">* </span>Collection Type</label>
                                            ...
                                            <div class="col-6 mb-3">
                                                ...
                                                <textarea class="form-control @error('title') is-invalid @enderror" name="description" id="description" cols="30" rows="5">{!! old('description')  !!}</textarea>
