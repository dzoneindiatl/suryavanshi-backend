...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Sliders</h1>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="container mt-4">
                <button type="button" class="btn btn-outline-primary my-1 me-2" fdprocessedid="g9dg58f"> Total Sliders:
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <thead>
                    <tr id="tableHeaders">
                        <th class="sortable" data-column="name">Media Type <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="coupon_type">Media Url <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="coupon_type">Title <i class="sort-icon ri-sort-asc"></i></th>
                ...
                <tbody>
                    ...
                    @include('admin.sliders.load_more_data', ['results' => $results])
                    @else
                    <tr>
