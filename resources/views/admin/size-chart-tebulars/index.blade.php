...
@section('content')
            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div class="prism-toggle">
                        ...
                        <a href="{{ route('admin-size-chart-tebulars.create') }}" class="btn btn-primary">Add Size Chart</a>
                    </div>
                </div>
                ...
                <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                    ...
                    <thead>
                        <tr id="tableHeaders">
                            <th class="sortable" data-column="name">View Size Chart <i class="sort-icon ri-sort-asc"></i>
                            </th>
                    ...
                    <tbody id="powerwidgets">
                        ...
                        @if ($results->isNotEmpty())
                            @include('admin.size-chart-tebulars.load_more_data', ['results' => $results])
                        @else
                            <tr>
    ...
    <!-- size char -->
    <div class="modal fade flip-modal size-chart-modal" id="addtocatt" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body size-chart-view">
                </div>
            </div>
        </div>
    </div>
        ...
        $(document).on('click', '#view-size-chart', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('.size-chart-view').html(data.partialsSize);
