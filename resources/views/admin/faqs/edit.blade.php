...
<div class="row">
    <div class="col-xl-12">
        <form action="{{route('admin-faqs.update',$userDetails->id)}}" method="post" enctype="multipart/form-data"
            id="editUserForm">
            @csrf
                                    ...
                                    <div class="card-body p-0">
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-xl-12 mb-3">
                                                ...
                                                <textarea class="form-control @error('title') is-invalid @enderror" name="answer" id="answer" cols="30" rows="5">{!! isset($userDetails->answer) ? $userDetails->answer: old('answer') !!}</textarea>
