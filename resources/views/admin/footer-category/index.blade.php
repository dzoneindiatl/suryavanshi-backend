        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                <div class="d-flex">
                    ...
                    <a href="{{ route('admin-footer-category.priority.manage') }}" class="btn btn-secondary" style="margin-left: 10px;">
                        Manage Priority
                    </a>
                </div>
                <div class="prism-toggle">
                    <a href="{{route('admin-'.$model.'.create')}}" class="btn btn-primary mb-3">Add
                    ...
                    <tbody id="powerwidgets" class="sortableCategories">
                        ...
                        <div class="hstack gap-2 flex-wrap">
                            ...
                            @endif
                                ...
                                <form method="POST"
                                    action="{{route('admin-'.$model.'.delete',['endepid'=>base64_encode($result->id)])}}">
                                    @csrf
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                            <ul class="nav nav-hoverable flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link"
                                                        href="{{route('admin-footer-subcategory.index',['endesid'=>base64_encode($result->id)])}}">
                                                        <span class="nav-text">Footer Sub Categories</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
