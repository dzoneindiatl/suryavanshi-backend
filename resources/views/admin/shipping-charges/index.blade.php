...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Shipping Zone</h1>
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    <a href="{{ route('admin-shipping-charges.create') }}" class="btn btn-primary">Add Shipping Charges</a>
                </div>
            </div>
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <thead>
                    <tr id="tableHeaders">
                        <th class="sortable" data-column="name">Country <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="name">Zone <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="name">Total  State <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="name">Shipping Method <i class="sort-icon ri-sort-asc"></i></th>
                ...
                <tbody id="powerwidgets">
                    ...
                    @include('admin.shipping-charges.load_more_data', ['results' => $results])
                    @else
                    <tr>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    tooltipElements.forEach(function (tooltipElement) {
        new bootstrap.Tooltip(tooltipElement); // Initialize each tooltip
    });
});
</script>
@endpush