...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Product Detail Sections</h1>
    <div class="ms-md-1 ms-0">
        <nav>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('admin-dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Product Detail Sections</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    @can('create_product_detail_manager')
                    <a href="{{ route('admin-product-detail-manager.create') }}" class="btn btn-primary"
                        style="margin-right: 10px;">
                        Add New Product Detail Section
                    </a>
                    @endcan
                </div>
            </div>
                        ...
                        <form id="listSearchForm" class="row mb-6">
                            ...
                            <div class="col-lg-3 mb-lg-5 mb-6">
                                ...
                                <input type="text" class="form-control" name="section_name" placeholder="Section Name"
                                    value="{{$searchVariable['section_name'] ?? '' }}">
                            </div>
                            <div class="col-lg-3 mb-lg-5 mb-6">
                                <label>Field Type</label>
                                <select name="field_type" class="form-control select2init">
                                    <option value="">All</option>
                                    <option value="textbox" {{ (isset($searchVariable['field_type']) && $searchVariable['field_type'] == 'textbox') ? 'selected' : '' }}>TextBox</option>
                                    <option value="textarea" {{ (isset($searchVariable['field_type']) && $searchVariable['field_type'] == 'textarea') ? 'selected' : '' }}>Textarea</option>
                                    <option value="ckeditor" {{ (isset($searchVariable['field_type']) && $searchVariable['field_type'] == 'ckeditor') ? 'selected' : '' }}>CK Editor</option>
                                </select>
                            </div>
                            <div class="col-lg-3 mb-lg-5 mb-6">
            ...
            <div class="container mt-4">
                <button type="button" class="btn btn-outline-primary my-1 me-2" fdprocessedid="g9dg58f"> Total Product Detail Manager:
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <thead>
                    <tr id="tableHeaders">
                        <th class="sortable" data-column="name">Section Name <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="coupon_type">Field Type <i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="coupon_type">Order<i class="sort-icon ri-sort-asc"></i></th>
                        <th class="sortable" data-column="coupon_type">Action <i class="sort-icon ri-sort-asc"></i></th>
                    </tr>
                </thead>
                <tbody id="powerwidgets" class="sortableDetailManager">
                    ...
                    @include('admin.product-detail-manager.load_more_data', ['results' => $results])
                    @else
                    <tr>
