        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    <a href="{{ route('admin-sub-category.add',base64_encode($dep_id)) }}" class="btn btn-primary">Add Sub Category</a>
                </div>
            </div>
            ...
            <div class="container mt-4">
                ...
                <a href="{{ route('admin-category.priority.submanage',base64_encode($dep_id)) }}" class="btn btn-secondary">
                    Manage Priority
                </a>
            </div>
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <tbody id="powerwidgets">
                    ...
                    @include('admin.sub-category.load_more_data', ['results' => $results])
                    @else
                    <tr>
