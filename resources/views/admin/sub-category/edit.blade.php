                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="width" name="width" value="{{ $category->width }}">
                        </div>
                        <div class="col-xl-6 mb-3">
                            <label for="thumbnail_image" class="form-label">Thumbnail Image Height</label>
                            <input type="text" class="form-control" id="height" name="height" value="{{ $category->height }}">
                        </div>
                        <div class="col-xl-6 mb-3">
