        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    <a href="{{ route('admin-product-categories-sub-category-create') }}" class="btn btn-primary mb-3"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="hstack gap-2 flex-wrap">
                                    <a href="{{ route('admin-product-categories-sub-category-edit',['token' => encrypt($subCategory->id)]) }}"
                                        class="btn btn-info"><i class="ri-edit-line"></i></a>
                                    <form method="POST"
                                        action="{{ route('admin-product-categories-sub-category-delete',['token' => encrypt($subCategory->id)]) }}">
                                        @csrf
