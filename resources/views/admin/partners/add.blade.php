...
<div class="row">
    <div class="col-xl-12">
        <form action="{{ route('admin-partners.save') }}" method="post" enctype="multipart/form-data"
            id="createPartnerForm">
            @csrf
                                    ...
                                    <div class="card-body p-0">
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <select class="js-example-placeholder-single form-control @error('gender') is-invalid @enderror"
