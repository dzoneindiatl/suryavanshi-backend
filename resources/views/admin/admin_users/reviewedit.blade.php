...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <form
                action="{{ route('admin-admin_users-reviewupdate', ['reviewId' => base64_encode($review->id), 'userId' => base64_encode($review->user_id)]) }}"
                            ...
                            @if ($review->image != '')
                                <div class="col-xl-6 mb-3 oldSlug">
                                    ...
                                    <img height="70" width="70"
                                        src="{{ config('constant.REVIEW_IMAGE_URL') . $review->image }}" />
                                </div>
                            @endif
