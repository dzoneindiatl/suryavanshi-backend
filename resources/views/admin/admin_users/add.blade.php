                                            ...
                                            <div class="row gy-3">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <select class="form-control @error('gender') is-invalid @enderror"
                                                        ...
                                                        <option value="" disabled
                                                            {{ old('gender', $userDetails->gender ?? '') == '' ? 'selected' : '' }}>
                                                            Select Gender
                                                        </option>
                                                        <option value="male"
                                                            {{ old('gender', $userDetails->gender ?? '') == 'male' ? 'selected' : '' }}>
                                                            Male
                                                        </option>
                                                        <option value="female"
                                                            {{ old('gender', $userDetails->gender ?? '') == 'female' ? 'selected' : '' }}>
                                                            Female
                                                        </option>
                                                        <option value="other"
                                                            {{ old('gender', $userDetails->gender ?? '') == 'other' ? 'selected' : '' }}>
                                                            Other
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <select name="roles" id="roles"
                                                        ...
                                                        <option value="" disabled
                                                            {{ old('roles', $userDetails->roles ?? '') == '' ? 'selected' : '' }}>
                                                            Select Role
                                                        </option>
                                                        @foreach ($roles as $key => $role)
                                                            <option value="{{ $key }}"
                                                                {{ old('roles', $userDetails->roles ?? '') == $key ? 'selected' : '' }}>
                                                                {{ $role }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <input type="password"
                                                        ...
                                                        value="{{ isset($userDetails->password) ? $userDetails->password : old('password') }}"
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <input type="password"
                                                        ...
                                                        value="{{ isset($userDetails->confirm_password) ? $userDetails->confirm_password : old('confirm_password') }}"
