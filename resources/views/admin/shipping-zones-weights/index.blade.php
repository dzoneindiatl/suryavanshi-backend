...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <!-- <h1 class="page-title fw-semibold fs-18 mb-0">Shipping Weight</h1> -->
    <a class="btn btn-dark" href="{{  route('admin-shipping-zones.index')}}">Back</a>
    <div class="ms-md-1 ms-0">
        <nav>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('admin-dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{  route('admin-shipping-zones.index')}}">Shipping Zone</a></li>
                <li class="breadcrumb-item active" aria-current="page">Shipping Weight</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <div class="prism-toggle">
                    ...
                    <a href="{{ route('admin-shipping-zones-weights.add',base64_encode($dep_id)) }}"
                    class="btn btn-primary">Add Shipping Weight</a>
                </div>
            </div>
            ...
            <table id="datatable-basic" data-sorting="" data-order="" class="table table-bordered text-nowrap"
                ...
                <thead>
                    <tr id="tableHeaders">
                        <th class="sortable" data-column="name">Weight  <i class="sort-icon ri-sort-asc"></i></th>
                ...
                <tbody id="powerwidgets">
                    ...
                    @include('admin.shipping-zones-weights.load_more_data', ['results' => $results])
                    @else
                    <tr>
