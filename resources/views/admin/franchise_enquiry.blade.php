...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <h1 class="page-title fw-semibold fs-18 mb-0">Franchise Enquiry</h1>
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                ...
                <a href="{{ route('admin-franchise-enquiry') }}" class="btn btn-success"
                    ...
                    <div id="collapseOne6" class="collapse m-3 {{ request('show') ? 'show' : '' }} ?>"
                        ...
                        <div>
                            ...
                            <form id="listSearchForm" class="row mb-6" method="GET"
                                action="{{ route('admin-franchiseEnquiries') }}">
                                ...
                                <div class="row mt-8">
                                    <div class="col-lg-12">
                                        ...
                                        &nbsp;&nbsp;
                                        <a href='{{ route('admin-franchiseEnquiries') }}'
            ...
            <div class="card-body">
               <table id="datatable-basic" class="table table-bordered text-nowrap" style="width:100%">
                ...
                <tbody>
                    @forelse($franchiseEnquiries as $index => $subscribes)
                        <tr data-id="{{ $subscribes->id }}">
                            <td>{{ $franchiseEnquiries->firstItem() + $index }}</td>
                            ...
                            <td class="company-text">{{ $subscribes->space ?? "N/A" }}</td>
                            <td class="gst-text">{{ $subscribes->investment ?? "N/A" }}</td>
    ...
    <div class="modal-content">
      <form id="editForm">
        ...
        <div class="modal-header">
          <h5 class="modal-title">Edit Franchise Enquiry</h5>
        ...
        <div class="modal-body">
          <div class="mb-3 edit_pop_sec row">
            ...
            <div class="col-md-6 edit_pop_sec1">
             <label>Space</label>
            <input type="text" class="form-control" name="space" id="edit_space" required>
            </div>
            <div class="col-md-6 edit_pop_sec1">
             <label>Investment</label>
            <input type="text" class="form-control" name="investment" id="edit_investment" required>
            </div>
          </div>
           <div class="mb-3">
...
$(document).ready(function () {
    ...
    $('.edit-btn').on('click', function () {
        ...
        $('#edit_city').val(city);
        $('#edit_space').val(company);
        $('#edit_investment').val(gst);
    ...
    $('#editForm').on('submit', function (e) {
        ...
        $.ajax({
            url: "{{ url('/admin/franchise-enquiries/update') }}/" + id,
            type: "POST",
            data: formData,
           success: function (response) {
                    ...
                    row.find('.company-text').text($('#edit_space').val());
                    row.find('.gst-text').text($('#edit_investment').val());
    ...
    $('.delete-btn').on('click', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ url('/admin/franchise-enquiries/delete') }}/" + id,
                    type: "DELETE",
