                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ $product->name }}" required>
                            @if ($errors->has('name'))
                        ...
                        <div class="row">
                            <div class="col  mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('sku') is-invalid @enderror" id="sku" value="{{ $product->sku }}" name="sku" required placeholder="SKU">
                                    @if ($errors->has('sku'))
                                        <div class=" invalid-feedback">
                                            {{ $errors->first('sku') }}
                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col  mb-3">
                                <div class="form-group">
                                    <label for="others">Desclaimer</label>
